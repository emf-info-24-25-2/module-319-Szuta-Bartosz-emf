...
public class ExerciceSwitch1 {
    public static void main(String[] args) {
         ...
         * 
         * } else if (noteDuModule==2) {System.out.println("Très insuffisant");
         * 
         * }else if (noteDuModule==3) {System.out.println("Insuffisant");
         * 
         * } else if (noteDuModule==4) {System.out.println("Suffisant");
         * 
         * }else if (noteDuModule==5) {System.out.println("Bien");
         * 
         * }else if (noteDuModule==6) {System.out.println("Très bien");
         */
        switch (noteDuModule) {
            case 1:
